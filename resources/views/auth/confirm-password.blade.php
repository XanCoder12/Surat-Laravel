...
<body>
    ...
    <div class="glass-card">
        <div class="card-title">Konfirmasi Kata Sandi</div>
        <div class="card-sub">
        ...
        <form method="POST" action="{{ route('password.confirm') }}">
            ...
            <div class="field-wrap">
                ...
                <input class="field-input" id="password" type="password" name="password" required autocomplete="current-password" placeholder="••••••••" autofocus>
                @error('password')
